...
| `@jeffgo10/react-canvas-designer` | **1.3.0** | Full StickPak designer; SP-024 zoom/pan (`panMode` prop, Space + drag, wheel); SP-012 rotation hotkeys; offset hole cut lines (deps helpers **1.0.5**) |
...
"@jeffgo10/react-canvas-designer": "1.3.0",
