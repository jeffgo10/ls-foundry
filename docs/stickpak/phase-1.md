...
| `@jeffgo10/react-canvas-designer` | **0.2.31** | `setSelectedSize` — typed width/height with aspect-ratio lock |
...
"@jeffgo10/react-canvas-designer": "0.2.31",
